...
COUNTRIES = {
    "nigeria": {
        ...
        "status": "brokerage",
        "currency": "₦",
        "tagline": "Home turf — direct vendor relationships, fastest turnaround.",
        "cities": {
            "benin_city": {
                "name": "Benin City",
                "spots": [
                    {
                        "id": "ng_bc_ring_road",
                        "name": "Ring Road Unipole",
                        "tag": "High-traffic city centre",
                        "desc": "The commercial heart of Benin City. Unmissable for anyone doing business downtown — banks, markets, government offices all converge here.",
                        "price_low": 150000, "price_high": 350000, "period": "month",
                    },
                    {
                        "id": "ng_bc_airport_road",
                        "name": "Airport Road Billboard",
                        "tag": "Arterial highway",
                        "desc": "Heavy daily commuter and cargo traffic heading to/from the airport corridor — strong for logistics, FMCG and travel brands.",
                        "price_low": 180000, "price_high": 400000, "period": "month",
                    },
                    {
                        "id": "ng_bc_sapele_road",
                        "name": "Sapele Road Digital Screen",
                        "tag": "Digital · Rotating",
                        "desc": "One of Benin's busiest commercial corridors, now with a digital screen for rotating creatives and multi-brand share of voice.",
                        "price_low": 220000, "price_high": 450000, "period": "month",
                    },
                    {
                        "id": "ng_bc_new_benin",
                        "name": "New Benin Market Frontage",
                        "tag": "Retail / footfall",
                        "desc": "Directly facing one of the busiest markets in Edo State — ideal for FMCG, fashion, and consumer goods brands.",
                        "price_low": 140000, "price_high": 300000, "period": "month",
                    },
                    {
                        "id": "ng_bc_uselu",
                        "name": "Uselu Junction Billboard",
                        "tag": "Transit hub",
                        "desc": "Major junction connecting university and residential traffic — great reach among students and young professionals.",
                        "price_low": 130000, "price_high": 280000, "month": "month", "period": "month",
                    },
                    {
                        "id": "ng_bc_gra",
                        "name": "GRA Entrance Unipole",
                        "tag": "Premium residential",
                        "desc": "Positioned at the entrance to Benin's Government Reserved Area — reaches high-income residents and decision-makers.",
                        "price_low": 200000, "price_high": 420000, "period": "month",
                    },
                    {
                        "id": "ng_bc_airport_led",
                        "name": "Benin Airport LED Screen",
                        "tag": "Digital · Airport",
                        "desc": "Full-motion LED at Benin Airport arrivals — premium exposure to business travelers and returning diaspora.",
                        "price_low": 300000, "price_high": 600000, "period": "month",
                    },
                ],
            },
        },
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    caption = (
        "🌍 <b>GlobalSpot</b> — by Affirmative Group / YUYU Ads\n\n"
        "<b>BIG IDEAS. WORLDWIDE IMPACT.</b>\n\n"
        "We broker premium billboard and digital OOH placements across "
        "Nigeria, the UAE, and an expanding global network spanning "
...
async def about(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    caption = (
        ...
        "GlobalSpot is Affirmative Group's international billboard brokerage "
        "desk, operated under YUYU Ads.\n\n"
        "🇳🇬 <b>Nigeria &amp; 🇦🇪 UAE</b> — active brokerage. We connect you "
        ...
        "All prices include YUYU's brokerage service — no hidden fees, "
...
async def show_spot(update: Update, context: ContextTypes.DEFAULT_TYPE, country_key: str, city_key: str, spot_id: str):
    ...
    caption = (
        ...
        f"{spot['desc']}\n\n"
        f"💰 <b>{price_line}</b>\n"
        f"<i>(incl. YUYU brokerage service — final quote confirmed with vendor)</i>\n\n"
